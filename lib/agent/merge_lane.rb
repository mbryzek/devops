...
module Agent
  module MergeLane
    ...
    #
    # `verified_by` is carried for a different reason: `assertions` needs it and
    # only sees a Candidate, never the raw PR it was computed from. It is nil
    # unless something has actually verified THIS head — see `.verified_by`.
