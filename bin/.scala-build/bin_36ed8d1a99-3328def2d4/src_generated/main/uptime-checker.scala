...
final class uptime$minuschecker$_ {
def args = uptime$minuschecker_sc.args$
def scriptPath = """bin/uptime-checker.sc"""
/*<script>*/
...
object uptime$minuschecker_sc {
  ...
  lazy val script = new uptime$minuschecker$_
...
export uptime$minuschecker_sc.script as `uptime-checker`
